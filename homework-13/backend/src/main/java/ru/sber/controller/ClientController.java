...
public class ClientController {
    ...
    @GetMapping
    public ResponseEntity<Void> getClientByName(@RequestBody Client client) {
        log.info("Проверяем что клиент с логином {} существует", client.getUsername());

        boolean isDeleted = clientInterfaceService.existsClientByName(client);
