...
import ru.sber.entity.ERole;
import ru.sber.entity.Role;
...
import ru.sber.repository.RoleRepository;
...
public class AuthController {
    ...
    public ResponseEntity<?> registerUser(@Valid @RequestBody SignupRequest signUpRequest) {
        log.info("Регистрация пользователя {}",signUpRequest);
